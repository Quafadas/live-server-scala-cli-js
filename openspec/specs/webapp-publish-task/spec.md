# webapp-publish-task Specification

## Purpose

The `publish` task on `ScalaJsWebAppModule` produces a self-contained deployment-ready site directory containing a correctly generated `index.html`, all minified/content-hashed JS outputs, and any static assets.
